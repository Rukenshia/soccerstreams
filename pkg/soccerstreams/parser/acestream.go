...
func (a *acestreamParser) Parse(comment string) []*soccerstream.Soccerstream {
...
func (a *acestreamParser) parseLine(line string) *soccerstream.Soccerstream {
